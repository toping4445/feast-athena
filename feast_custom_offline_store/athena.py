...
#from feast import OnDemandFeatureView, AthenaSource
...
#from feast.infra.offline_stores.athena_source import (
#    AthenaLoggingDestination,
#    SavedDatasetAthenaStorage,
#)
from feast_custom_offline_store.athena_source import SavedDatasetAthenaStorage, AthenaLoggingDestination
from feast_custom_offline_store import aws_utils,offline_utils
...
class AthenaOfflineStoreConfig(FeastConfigBaseModel):
    ...
    type: Literal["feast_custom_offline_store.athena.AthenaOfflineStore"] = "feast_custom_offline_store.athena.AthenaOfflineStore"
