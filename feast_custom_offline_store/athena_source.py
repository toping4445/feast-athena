...
from feast_custom_offline_store import type_map
...
class AthenaSource(DataSource):
    ...
    def get_table_column_names_and_types(
        ...
        from feast_custom_offline_store.athena import AthenaOfflineStoreConfig
        from feast_custom_offline_store import aws_utils
