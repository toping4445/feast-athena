...
class FeatureViewQueryContext:
    """Context object used to template a BigQuery,Redshift and Athena point-in-time SQL query"""
...
def get_feature_view_query_context(
    ...
    for feature_view, features in feature_views_to_feature_map.items():
        ...
        data_partition_column = reverse_field_mapping.get(
        ...
        context = FeatureViewQueryContext(
            ...
            date_partition_column=data_partition_column
        )
